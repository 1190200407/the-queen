...
public sealed class AmalgamApplyVulnerableIntentAction : AmalgamActionModel
{
    ...
    public override LocString IntentTitle => new("monsters", "FRIENDLY_AMALGAM.intent_vulnerable.title");

    public override LocString GetIntentDescription()
    {
        LocString desc = new("monsters", "FRIENDLY_AMALGAM.intent_vulnerable.description");
