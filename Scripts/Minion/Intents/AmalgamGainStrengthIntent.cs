...
/// <summary>友方聚合体力量意图；展示为增益并显示层数。</summary>
public sealed class AmalgamGainStrengthIntent : AbstractIntent
{
    private readonly int _stacks;

    public AmalgamGainStrengthIntent(decimal stacks)
    {
    ...
    protected override string IntentPrefix => "AMALGAM_GAIN_STRENGTH";
