...
public sealed class AmalgamDrawAndEnchantWithAmountIntent : AbstractIntent
{
    private readonly int _count;
    private readonly string _enchantmentId;
    private readonly int _enchantAmount;

    public AmalgamDrawAndEnchantWithAmountIntent(decimal count, string enchantmentId, decimal enchantAmount)
    {
