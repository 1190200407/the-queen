...
/// <summary>友方聚合体：在手牌中加入 1 张防御衍生牌与 1 张输出衍生牌的意图展示。</summary>
public sealed class AmalgamFabricateIntent : AbstractIntent
{
    public override IntentType IntentType => IntentType.Summon;

    protected override string IntentPrefix => "AMALGAM_FABRICATE";
