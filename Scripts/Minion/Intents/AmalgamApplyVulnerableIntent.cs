...
/// <summary>友方聚合体：对敌人施加若干层 <see cref="MegaCrit.Sts2.Core.Models.Powers.VulnerablePower"/> 的意图展示。</summary>
public sealed class AmalgamApplyVulnerableIntent : AbstractIntent
{
    private readonly int _stacks;

    public AmalgamApplyVulnerableIntent(decimal stacks)
    {
    ...
    protected override string IntentPrefix => "AMALGAM_APPLY_VULNERABLE";

    protected override string SpritePath => "atlases/intent_atlas.sprites/intent_debuff.tres";

    protected override LocString IntentLabelFormat => new("intents", "FORMAT_VULNERABLE_STACKS");
