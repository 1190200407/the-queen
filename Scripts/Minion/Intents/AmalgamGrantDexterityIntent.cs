...
/// <summary>友方聚合体：你获得敏捷（展示）。</summary>
public sealed class AmalgamGrantDexterityIntent : AbstractIntent
{
    private readonly int _stacks;

    public AmalgamGrantDexterityIntent(decimal stacks)
    {
    ...
    protected override string IntentPrefix => "AMALGAM_GRANT_DEXTERITY";
