...
public class QueenCardPool : TypeListCardPoolModel
{
    ...
    private static readonly Material? _poolFrameMaterial = MaterialUtils.CreateHsvShaderMaterial(0.79310346f, 0.6041667f, 144f/255f);
