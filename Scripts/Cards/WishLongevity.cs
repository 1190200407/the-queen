...
/// <summary>长生不老：获得覆甲。魂缚消逝衍生能力牌。</summary>
[RegisterCard(typeof(TokenCardPool))]
public sealed class WishLongevity : QueenCardModel
{
    ...
    {
        base.DynamicVars.Power<PlatingPower>().UpgradeValueBy(2m);
    }
}
